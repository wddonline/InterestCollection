 ...
 */
package org.wdd.app.android.interestcollection.permission;
...
public class PermissionManager {
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull android.support.v4.app.Fragment fragment) {
    ...
    public static
    @NonNull
    SettingService defineSettingDialog(@NonNull android.support.v4.app.Fragment fragment) {
