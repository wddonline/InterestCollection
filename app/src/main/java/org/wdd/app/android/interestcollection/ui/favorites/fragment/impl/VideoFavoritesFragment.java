...
import org.wdd.app.android.interestcollection.ui.favorites.adapter.impl.VideoFavoritesAdapter;
import org.wdd.app.android.interestcollection.ui.favorites.fragment.FavoritesFragment;
import org.wdd.app.android.interestcollection.ui.favorites.presenter.VideoFavoritesPresenter;
...
public class VideoFavoritesFragment extends FavoritesFragment implements VideoFavoritesAdapter.VideoFavoritesCallback {

    private View mRootView;
    private RecyclerView mRecyclerView;
    private LoadView mLoadView;

    private List<VideoFavoritesAdapter.VideoItem> mFavorites;
    private VideoFavoritesPresenter mPresenter;
    ...
    protected void lazyLoad() {
        mPresenter.getVideoFavorites();
    }

    private void initData() {
        mPresenter = new VideoFavoritesPresenter(this);
    }
    ...
    public void bindVideoListViews(List<VideoFavorite> data) {
        mFavorites = new ArrayList<>();
        for (VideoFavorite favorite : data) {
            mFavorites.add(new VideoFavoritesAdapter.VideoItem(false, favorite));
        }
        mAdapter = new VideoFavoritesAdapter(getContext(), mFavorites);
    ...
    @Override
    public void jumpToDetailActivity(int id, Video video) {
        VideoDetailActivity.showForResult(getActivity(), id, video, FavoritesActivity.REQUEST_CODE_DETAIL);
    }
    ...
    public void showDeleteOverViews() {
        hideLoadingDialog();
        List<VideoFavoritesAdapter.VideoItem> selectedItems = mAdapter.getSelectedOriginItem();
